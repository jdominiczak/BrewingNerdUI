...
export default class BnDate {
  ...
  static DAYS = ["Mon", "Tues", "Weds", "Thurs", "Fri", "Sat", "Sun"];
  static DAYS_FULL = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
  ...
  static toWordsDateAndDay(dateTime) {
    return this.DAYS_FULL[dateTime.getDay()] + " " + dateTime.getDate() + " " + this.MONTHS[dateTime.getMonth()] + " " + dateTime.getFullYear();
  }

  // return Monday 11 Aug 2017 15:24
  static toWordsDateAndDayAndTime(dateTime) {
    return this.DAYS_FULL[dateTime.getDay()] + " " + dateTime.getDate() + " " + this.MONTHS[dateTime.getMonth()] + " " + dateTime.getFullYear() + " " + this.toPrettyTime(dateTime);
  }

  // return 11 Aug. 2017
  static toWordsDate(dateTime) {
    return dateTime.getDate() + " " + this.MONTHS[dateTime.getMonth()] + " " + dateTime.getFullYear();
  }
